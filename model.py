...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct  5 12:38:14 2017
...
class CharCNN(object):
    ...
    #def __init__(self, num_classes=2, filter_sizes=(7, 7, 3, 3, 3, 3), num_filters_per_size=256,
        ...
        self.input_x = tf.placeholder(tf.float32, [None, sequence_length, 1, 1], name="input_x")
        ...
        with tf.name_scope("conv-maxpool-1"):
            #filter_shape = [num_quantized_chars, filter_sizes[0], 1, num_filters]
            filter_shape = [embedding_size, filter_sizes[0], 1, num_filters]
        ...
        # ================ Layer 7 ================
        num_features_total = 34 * num_filters
