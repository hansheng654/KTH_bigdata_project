...
tf.flags.DEFINE_integer('n_samples', 16000,#None,
...
for i in range(FLAGS.train_steps):
    ...
    train_loss, acc_train, summary = sess.run([nn.loss, nn.train_step, nn.merged],
    ...
    file_re.writelines('{0}/{1} train loss: {2:.4f} (accuracy {1:.4f})\n'.format(i + 1, FLAGS.train_steps, train_loss,acc_train))
    print('{0}/{1} train loss: {2:.4f} (accuracy {1:.4f})'.format(i + 1, FLAGS.train_steps, train_loss,acc_train))
