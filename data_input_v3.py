...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct  9 21:56:38 2017
...
use_bigrams = False  #whether to use biagrams as features

def _import_data():
    """ V3, updated 09/10 with only positive / negative data. Positive are 1, negative are 0 
...
#                count+=1
#                
#    del X[0]400_labeled.pkl label_400.pkl  '400_dataset_for_CNN_0ishappy.pkl' 100k_tweets.pkl
    #with open (Millionaire, 'rb') as fp: '400_dataset_for_CNN.pkl'
    #with open ('400_labeled.pkl', 'rb') as fp:    
        #X = pickle.load(fp)
        
    with open ('400_dataset_for_CNN.pkl', 'rb') as fp:    
        X, Y = pickle.load(fp)
